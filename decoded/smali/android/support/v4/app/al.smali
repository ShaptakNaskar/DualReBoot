...
.method public final a(Landroid/support/v4/app/ag;)Landroid/app/Notification;
    ...
    iget-object v1, v0, Landroid/support/v4/app/ag;->a:Landroid/content/Context;

    move-object/from16 v0, p1

    iget-object v2, v0, Landroid/support/v4/app/ag;->r:Landroid/app/Notification;

    move-object/from16 v0, p1

    iget-object v3, v0, Landroid/support/v4/app/ag;->b:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v4, v0, Landroid/support/v4/app/ag;->c:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v5, v0, Landroid/support/v4/app/ag;->h:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v6, v0, Landroid/support/v4/app/ag;->f:Landroid/widget/RemoteViews;

    move-object/from16 v0, p1

    iget v7, v0, Landroid/support/v4/app/ag;->i:I

    move-object/from16 v0, p1

    iget-object v8, v0, Landroid/support/v4/app/ag;->d:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v9, v0, Landroid/support/v4/app/ag;->e:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v10, v0, Landroid/support/v4/app/ag;->g:Landroid/graphics/Bitmap;

    move-object/from16 v0, p1

    iget v11, v0, Landroid/support/v4/app/ag;->n:I

    move-object/from16 v0, p1

    iget v12, v0, Landroid/support/v4/app/ag;->o:I

    move-object/from16 v0, p1

    iget-boolean v13, v0, Landroid/support/v4/app/ag;->p:Z
