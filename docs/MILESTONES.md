...
**Current phase: milestone 4 — animation and scene behavior (starting).**
...
| 3. Static rendering | Geometry, materials, cameras, parent transforms and a native rendered frame | Prototype delivered; visual parity still open | 167 models / 4,347 triangles; [render results](../reports/NATIVE-GEOMETRY.md) |
| 4. Animation and behavior | Correct initial visibility, time of day, water/object motion, effects and dynamic text | Starting | Next section begins at byte 372,259; tasks below |
...
- [ ] Decode vertex-animation records and their model references.
