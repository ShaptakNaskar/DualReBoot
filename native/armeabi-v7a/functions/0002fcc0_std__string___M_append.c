...

{
  ...
  if (psVar4 <= psVar11) {
    ...
    if ((string *)(-2 - (int)psVar4) < psVar11) {
      ...
      __stl_throw_length_error((char *)(DAT_00030060 + 0x30024));
    }
    psVar3 = psVar4;
    if (psVar4 < psVar11) {
      psVar3 = psVar11;
...
LAB_0002ffd4:
      ...
      local_2c[0] = psVar3;
      if ((string *)0x80 < psVar3) goto LAB_0002ffd4;
...
LAB_0002fec8:
        ...
        if (psVar4 != psVar14) goto LAB_0002fec8;
      }
      psVar14 = psVar3 + (int)psVar4;
    }
    if ((int)psVar11 < 1) goto LAB_0002ff88;
...
LAB_0002ff70:
      ...
      if (psVar11 != psVar13) goto LAB_0002ff70;
    }
...
LAB_0002ff88:
  ...
  if ((int)uVar6 < 1) goto LAB_0002fdbc;
  pcVar5 = (char *)(iVar8 + 1);
  uVar7 = uVar6 >> 2;
...
LAB_0002fda4:
    ...
    uVar6 = uVar6 + uVar7 * -4;
    pcVar5 = pcVar5 + uVar1;
    pcVar15 = pcVar15 + uVar1;
    if (bVar17) goto LAB_0002fda4;
  }
  iVar8 = *(int *)(this + 0x10);
LAB_0002fdbc:
