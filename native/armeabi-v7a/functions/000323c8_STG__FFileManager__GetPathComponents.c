/* 000323c8 | STG::FFileManager::GetPathComponents */
...

{
  ...
  piVar9 = *(int **)(DAT_00032960 + 0x323e8);
  local_2c = *piVar9;
  iVar8 = *(int *)(DAT_00032964 + 0x323fc);
  iVar10 = iVar8 + 8;
  ...
  if (uVar5 == 0) {
    ...
    std::__stl_throw_length_error((char *)(DAT_00032970 + 0x32850));
  }
  if (0x10 < uVar5) {
    local_d8 = uVar5;
    if (uVar5 < 0x81) {
  ...
  *local_50 = (string)0x0;
  std::string::_M_append
            ((string *)local_60,(char *)(DAT_00032968 + 0x32520),(char *)(DAT_00032968 + 0x32521));
  psVar4 = local_4c;
  psVar3 = local_50;
  local_48 = iVar8 + 8;
  ...
  if (uVar5 == 0) {
                    /* WARNING: Subroutine does not return */
    std::__stl_throw_length_error((char *)(DAT_0003296c + 0x32844));
  }
  if (0x10 < uVar5) {
    local_d8 = uVar5;
    if (uVar5 < 0x81) {
  ...
  *local_34 = (string)0x0;
  ...
  if (sVar11 < uVar5) {
    iVar10 = 0;
    if (sVar11 != 0) {
      memmove(pvVar6,local_84,sVar11);
      iVar10 = *(int *)(param_3 + 0x14) - *(int *)(param_3 + 0x18);
    }
    std::string::_M_append((string *)(param_3 + 4),(char *)((int)puVar2 + iVar10),(char *)puVar1);
    puVar7 = *(undefined1 **)(param_4 + 0x14);
    pvVar6 = *(void **)(param_4 + 0x18);
    __n = (int)local_6c - (int)local_68;
    sVar11 = (int)puVar7 - (int)pvVar6;
    if (sVar11 < __n) goto LAB_00032888;
  }
  else {
    if (uVar5 != 0) {
...
LAB_00032888:
      ...
      if (sVar11 != 0) {
        ...
        iVar10 = *(int *)(param_4 + 0x14) - *(int *)(param_4 + 0x18);
      }
      std::string::_M_append((string *)(param_4 + 4),(char *)((int)puVar2 + iVar10),(char *)puVar1);
      goto LAB_0003274c;
    }
  }
  if (__n != 0) {
