/* 000382fc | STG::GEMaterial::SetTexture */
...

{
  ...
  piVar1 = *(int **)(this + iVar8 * 4 + 4);
  if ((piVar1 != (int *)0x0) && (iVar4 = piVar1[1], piVar1[1] = iVar4 + -1, iVar4 == 1)) {
    (**(code **)(*piVar1 + 4))();
  }
  *(GETexture **)(this + iVar8 * 4 + 4) = param_2;
  if (param_2 != (GETexture *)0x0) {
    pGVar6 = param_2;
    if ((string *)(this + param_1 * 0x20 + 0x70) != (string *)(param_2 + 0xc)) {
      ...
      if (__n < __n_00) {
        ...
        iVar8 = *(int *)(this + iVar8 * 4 + 4);
        uVar9 = *(undefined4 *)(iVar8 + 0x2c);
        *(undefined4 *)(this + param_1 * 0x20 + 0x88) = *(undefined4 *)(param_2 + 0x24);
        *(undefined4 *)(this + param_1 * 4 + 0xac) = uVar9;
        *(undefined4 *)(this + param_1 * 4 + 0xb4) = *(undefined4 *)(iVar8 + 0x30);
        goto LAB_00038420;
      }
      if (__n_00 != 0) {
        memmove(__dest,__src,__n_00);
      }
      puVar5 = *(undefined1 **)(this + param_1 * 0x20 + 0x80);
      puVar3 = (undefined1 *)(*(int *)(this + param_1 * 0x20 + 0x84) + __n_00);
      if (puVar3 != puVar5) {
        *(undefined1 *)(*(int *)(this + param_1 * 0x20 + 0x84) + __n_00) = *puVar5;
        *(undefined1 **)(this + param_1 * 0x20 + 0x80) =
             puVar3 + (*(int *)(this + param_1 * 0x20 + 0x80) - (int)puVar5);
      }
      pGVar6 = *(GETexture **)(this + iVar8 * 4 + 4);
    }
    uVar9 = *(undefined4 *)(pGVar6 + 0x2c);
    *(undefined4 *)(this + param_1 * 0x20 + 0x88) = *(undefined4 *)(param_2 + 0x24);
    *(undefined4 *)(this + param_1 * 4 + 0xac) = uVar9;
...
LAB_00038420:
  ...
  *(undefined4 *)(this + param_1 * 4 + 0x3c) = uVar9;
  *(undefined4 *)(this + param_1 * 4 + 0x44) = uVar7;
