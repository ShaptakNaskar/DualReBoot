/* 0003b450 | STG::GERendererAPI::GL_SetBlendState */
...

{
  ...
  iVar2 = DAT_0003b4cc + 0x3b49c + param_1 * 0x18;
  glBlendFunc(*(undefined4 *)(DAT_0003b4cc + 0x3b49c + param_1 * 0x18),*(undefined4 *)(iVar2 + 4));
