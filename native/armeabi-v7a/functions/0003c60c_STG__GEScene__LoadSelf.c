...

{
  ...
  iVar3 = DAT_0003c7e8 + 0x3c62c;
  if (param_1 == (FFileBase *)0x0) {
    uVar1 = 0;
  }
  else {
    puVar4 = *(uint **)(iVar3 + DAT_0003c7ec);
    if ((*puVar4 & 1) == 0) {
      iVar2 = thunk_FUN_0007004c(puVar4);
      this_00 = *(UTime **)(iVar3 + DAT_0003c7f0);
      if (iVar2 != 0) {
        UTime::UTime(this_00);
        thunk_FUN_000700b0(puVar4);
        __aeabi_atexit(this_00,*(undefined4 *)(iVar3 + DAT_0003c7f4),
                       *(undefined4 *)(iVar3 + DAT_0003c7f8));
      }
    }
    else {
      this_00 = *(UTime **)(iVar3 + DAT_0003c7f0);
    ...
    if (((*puVar4 & 1) == 0) && (iVar2 = thunk_FUN_0007004c(puVar4), iVar2 != 0)) {
      UTime::UTime(this_00);
      thunk_FUN_000700b0(puVar4);
      __aeabi_atexit(this_00,*(undefined4 *)(iVar3 + DAT_0003c7f4),
                     *(undefined4 *)(iVar3 + DAT_0003c7f8));
    ...
    *(undefined4 *)(this + 0x608) = uStack_38;
