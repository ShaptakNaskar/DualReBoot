/* 0004bb00 | STG::LLogicSceneWrapper::FindModel */
...

{
  ...
  iVar6 = DAT_0004be30 + 0x4bb18;
  iVar2 = *(int *)this;
  piVar7 = *(int **)(iVar6 + DAT_0004be34);
  uVar8 = *(ulong *)(iVar2 + 0xa4);
  local_2c = *piVar7;
  if (uVar8 != 0) {
    uVar19 = 0;
    iVar17 = *(int *)(iVar6 + DAT_0004be38) + 8;
    do {
      ...
      if (uVar3 == 0) {
        ...
        std::__stl_throw_length_error((char *)(DAT_0004be40 + 0x4bde4));
      }
      if (0x10 < uVar3) {
        local_68 = uVar3;
        if (uVar3 < 0x81) {
      ...
      *(byte *)local_50 = 0;
      ...
      if (uVar3 == 0) {
                    /* WARNING: Subroutine does not return */
        std::__stl_throw_length_error((char *)(DAT_0004be44 + 0x4bdf0));
      }
      if (0x10 < uVar3) {
        local_68 = uVar3;
        if (uVar3 < 0x81) {
