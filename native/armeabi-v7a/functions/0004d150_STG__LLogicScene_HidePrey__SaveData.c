/* 0004d150 | STG::LLogicScene_HidePrey::SaveData */
...
LAB_0004d31c:
          ...
          std::__stl_throw_out_of_range((char *)(DAT_0004d334 + 0x4d328));
        }
        uVar3 = 0;
        while( true ) {
          ...
          iVar2 = *(int *)(iVar4 + 0x18);
          if ((uint)(*(int *)(iVar4 + 0x14) - iVar2) <= uVar3) goto LAB_0004d31c;
        }
      }
      uVar7 = uVar7 + 1;
      iVar6 = iVar6 + 0x1c;
...
LAB_0004d328:
                    /* WARNING: Subroutine does not return */
          std::__stl_throw_out_of_range((char *)((int)&DAT_0004d334 + DAT_0004d338));
        }
        uVar3 = 0;
        while( true ) {
          puVar1 = (undefined1 *)(iVar2 + uVar3);
          ...
          if (uVar5 == uVar3) break;
          iVar2 = *(int *)(iVar4 + 0x18);
          if ((uint)(*(int *)(iVar4 + 0x14) - iVar2) <= uVar3) goto LAB_0004d328;
        }
      }
      uVar7 = uVar7 + 1;
      iVar6 = iVar6 + 0x1c;
