...

{
  ...
  FFileBase::Write(param_1,(uchar *)local_2c,4);
  FFileBase::Write(param_1,&local_2f,1);
...
LAB_000543ec:
          ...
          std::__stl_throw_out_of_range((char *)((int)&DAT_000543f8 + DAT_000543f8));
        }
        uVar3 = 0;
        while( true ) {
          ...
          iVar2 = *(int *)(iVar4 + 0x28);
          if ((uint)(*(int *)(iVar4 + 0x24) - iVar2 >> 1) <= uVar3) goto LAB_000543ec;
        }
      }
      uVar6 = uVar6 + 1;
      iVar5 = iVar5 + 0x2c;
