...

{
  ...
  piVar2 = *(int **)(DAT_00057090 + 0x56f1c);
  local_1c = *piVar2;
  FFileBase::Peek((uchar *)param_1,(ulong)&local_78);
  if (iStack_74 == 0x4d454854 && local_78 == 0x46455250) {
  ...
  if (local_80 != 0) {
    ...
    do {
      ...
      iVar1 = *(int *)(param_2 + 0x7c) + iVar3;
      iVar3 = iVar3 + 0x38;
      Load<char,int>(param_1,(UStringBase *)(iVar1 + 0x1c));
    } while (uVar4 < local_80);
  }
  iVar3 = *(int *)(DAT_00057094 + 0x5700c) + 8;
  local_38 = iVar3;
