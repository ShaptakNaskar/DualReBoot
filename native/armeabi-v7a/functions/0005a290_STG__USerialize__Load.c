...

{
  ...
  piVar14 = *(int **)(DAT_0005a9d0 + 0x5a2b0);
  local_2c = *piVar14;
  ...
  *(undefined4 *)(param_2 + 0x144) = local_d8;
  ...
  if (local_d4 != 0) {
    uVar11 = 0;
    iVar15 = *(int *)(DAT_0005a9d4 + 0x5a344);
    pGVar12 = param_2;
    do {
        ...
        if (local_50 != local_54) {
          ...
          if (uVar16 < __n) {
            if (uVar16 == 0) {
              ...
              if (ppuVar5 == ppuVar13) goto LAB_0005a490;
...
LAB_0005a830:
                  ...
                  if (uVar16 != uVar8 * 4) goto LAB_0005a830;
                }
...
LAB_0005a8e0:
                  ...
                  uVar8 = __n + uVar16 * -4;
                  if (uVar16 * 4 != __n) goto LAB_0005a8e0;
                }
