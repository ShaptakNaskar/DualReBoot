/* 0005d7f0 | STG::UCrypto::TransformAndPrint */
...

{
  ...
  piVar1 = *(int **)(DAT_0005d8fc + 0x5d800);
  local_2c = *piVar1;
  uVar5 = 0;
  do {
    uVar3 = uVar5;
  ...
  if (uVar3 != 0) {
    ...
    do {
      ...
      uVar4 = uVar4 + 4;
      FUN_0005d6ac(1,iVar8,uVar2);
    } while (uVar6 != uVar3);
  }
  FUN_0005d6ac(1,DAT_0005d904 + 0x5d8d4,uVar3,param_1);
  if (local_2c == *piVar1) {
    return;
  }
