/* 0005ee74 | STG::UResource::GetAllSubFiles */
...

{
  ...
  iVar12 = DAT_0005f48c + 0x5ee8c;
  piVar9 = *(int **)(iVar12 + DAT_0005f490);
  local_2c = *piVar9;
      ...
      *(int *)(param_1 + 4) = iVar3;
      ...
      if (iVar14 != 0) {
        ...
        while (iVar14 != (int)pvVar5 + 0x1c) {
          *(int *)((int)pvVar5 + -4) = *(int *)(iVar12 + DAT_0005f494) + 8;
  ...
  if (iVar3 == 0) {
    ...
    iVar14 = 0;
    local_70 = 0;
    iVar18 = *(int *)(iVar12 + DAT_0005f494) + 8;
    do {
      while( true ) {
...
LAB_0005ef2c:
        iVar14 = iVar14 + 1;
        if (iVar14 == iVar3) goto LAB_0005f04c;
      }
...
LAB_0005f100:
              ...
              *(undefined4 *)(iVar4 + 0x1c) = *(undefined4 *)(iVar15 + 0x1c);
              iVar4 = iVar16 + 1;
              if (iVar16 + 1 == iVar14) goto LAB_0005f198;
            }
            ...
            iVar11 = 0;
            if (sVar10 != 0) {
              memmove(pvVar5,pvVar19,sVar10);
              iVar11 = *(int *)(iVar4 + 0x14) - *(int *)(iVar4 + 0x18);
            }
            std::string::_M_append((string *)(iVar4 + 4),(char *)((int)pvVar19 + iVar11),pcVar20);
            iVar18 = iVar18 + 0x20;
            *(undefined4 *)(iVar4 + 0x1c) = *(undefined4 *)(iVar15 + 0x1c);
            iVar4 = iVar16 + 1;
          } while (iVar16 + 1 != iVar14);
LAB_0005f198:
          local_70 = local_70 + iVar16 + 1;
          if (local_50 != 0) {
            if (local_54 != 0) {
