/* 0005ffe0 | STG::UPreference<STG::UStringBase<unsigned_short,unsigned_short>,true>::SetSelectedValueByName */
...

{
  ...
  piVar8 = *(int **)(DAT_00060128 + 0x60000);
  local_2c = *piVar8;
  uVar7 = 0;
  iVar9 = *(int *)(DAT_0006012c + 0x60018);
  local_48 = iVar9 + 8;
