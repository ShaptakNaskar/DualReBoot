/* 0006130c | STG::UPreference_Bool::PrintValue */
...

{
  ...
  iVar9 = DAT_00061514;
  piVar8 = *(int **)(DAT_00061504 + 0x61328);
  local_24 = *piVar8;
  if (*(char *)(*(int *)(this + 0x7c) + param_1) == '\0') {
    iVar6 = DAT_00061508 + 0x61344;
  }
  else {
    iVar6 = DAT_00061520 + 0x614d8;
  }
  __s = (char *)(DAT_0006150c + 0x61794);
  snprintf(__s,0x20,(char *)(DAT_00061510 + 0x61364),iVar6);
  iVar9 = *(int *)(iVar9 + 0x61378);
  local_40 = iVar9 + 8;
  local_2c = local_3c;
  local_28 = local_3c;
  sVar2 = strlen(__s);
  ...
  if (uVar3 == 0) {
    ...
    std::__stl_throw_length_error((char *)(DAT_0006151c + 0x61488));
  }
  ppcVar5 = local_3c;
  if (0x10 < uVar3) {
    local_44 = uVar3;
  ...
  if (__s + sVar2 != (char *)(DAT_00061518 + 0x61814)) {
    pvVar4 = memcpy(ppcVar5,(char *)(DAT_00061518 + 0x61814),__n);
