/* 00061524 | STG::UPreferenceBase::GenerateDefaultKey */
...

{
  ...
  piVar12 = *(int **)(DAT_000619e8 + 0x61544);
  local_2c = *piVar12;
  iVar11 = *(int *)(DAT_000619ec + 0x61558);
  iVar13 = iVar11 + 8;
  ...
  if (uVar4 == 0) {
    ...
    std::__stl_throw_length_error((char *)(DAT_000619f8 + 0x61968));
  }
  if (0x10 < uVar4) {
    local_f4 = uVar4;
    if (uVar4 < 0x81) {
  ...
  *local_c0 = (string)0x0;
  ...
  std::string::_M_append
            ((string *)local_d0,(char *)(DAT_000619f0 + 0x61600),(char *)(DAT_000619f0 + 0x61601));
  psVar3 = local_bc;
  psVar2 = local_c0;
  ...
  if (*(byte **)(this + 0x1c) != pbVar15) {
    piVar7 = *(int **)(DAT_000619f4 + 0x61760);
