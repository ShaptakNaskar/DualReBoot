/* 00061eb4 | FUN_00061eb4 */

/* WARNING: Removing unreachable block (ram,0x0006251c) */

void FUN_00061eb4(int param_1,int param_2)

{
  ...
  __s = *(char **)(DAT_00062918 + 0x61ee0);
  piVar19 = *(int **)(DAT_0006291c + 0x61edc);
  local_2c = *piVar19;
  iVar17 = *(int *)(DAT_00062920 + 0x61ef0);
  local_b8 = iVar17 + 8;
  ...
  if (uVar15 == 0) {
    if (sVar6 != 0) goto LAB_00061f38;
    local_104 = 0;
    uVar10 = 0;
LAB_000623c0:
    sVar6 = (int)(pcVar18 + uVar10) - (int)pcVar18;
    uVar15 = sVar6 + 1;
    iVar14 = *(int *)(DAT_00062928 + 0x623ec);
    local_d8 = local_e8;
    local_d4 = local_e8;
    if (uVar15 == 0) {
                    /* WARNING: Subroutine does not return */
      std::__stl_throw_length_error((char *)(DAT_0006292c + 0x62634));
    }
    if (0x10 < uVar15) {
      local_ec = uVar15;
      if (uVar15 < 0x81) {
    ...
    *(undefined1 *)local_d8 = 0;
    ...
    if (uVar15 < local_104) {
                    /* WARNING: Subroutine does not return */
      std::__stl_throw_out_of_range((char *)((int)&DAT_00062918 + DAT_00062940));
    }
    ...
    if (uVar15 == 0) {
                    /* WARNING: Subroutine does not return */
      std::__stl_throw_length_error((char *)(DAT_00062930 + 0x62640));
    }
    if (0x10 < uVar15) {
      local_ec = uVar15;
      if (uVar15 < 0x81) {
        ...
        if (pcVar8 == __s + 1) {
          ...
          while (pcVar22 = pcVar23, pcVar9 = pcVar20, pcVar22 != pcVar20) {
            ...
            if (*pcVar22 == *__s) {
              while( true ) {
                pcVar9 = pcVar20;
                if (pcVar20 == pcVar3) goto LAB_00062164;
                pcVar13 = pcVar2 + 1;
                if (*pcVar3 != *pcVar2) break;
                pcVar9 = pcVar22;
                pcVar2 = pcVar13;
                pcVar3 = pcVar3 + 1;
                if (pcVar8 == pcVar13) goto LAB_00062164;
              }
            }
          }
        }
...
LAB_00061f38:
  ...
  if (param_2 == 0) {
    ...
    if (uVar15 == 0) {
                    /* WARNING: Subroutine does not return */
      std::__stl_throw_length_error((char *)(DAT_00062934 + 0x6264c));
    }
    if (0x10 < uVar15) {
      local_ec = uVar15;
      if (uVar15 < 0x81) {
    ...
    *local_6c = (string)0x0;
    pcVar18 = *(char **)(DAT_00062924 + 0x6222c);
    ...
    if (uVar15 == 0) {
                    /* WARNING: Subroutine does not return */
      std::__stl_throw_length_error((char *)(DAT_0006293c + 0x62664));
    }
    if (0x10 < uVar15) {
      local_ec = uVar15;
      if (uVar15 < 0x81) {
    ...
    *local_50 = (string)0x0;
    ...
    local_80 = iVar17 + 8;
    if ((local_68 == (string *)local_7c) || (local_68 == (string *)0x0)) goto LAB_000620cc;
    ...
    if (uVar15 == 0) {
                    /* WARNING: Subroutine does not return */
      std::__stl_throw_length_error((char *)(DAT_00062938 + 0x62658));
    }
    if (0x10 < uVar15) {
      local_ec = uVar15;
      if (uVar15 < 0x81) {
    ...
    *local_34 = (string)0x0;
    ...
    local_48 = iVar17 + 8;
    if ((local_30 == (string *)local_44) || (local_30 == (string *)0x0)) goto LAB_000620cc;
