/* 00062fbc | STG::UPreference_FileChooser::GetKeyPrefix */
...

{
  ...
  piVar2 = *(int **)(DAT_0006312c + 0x62fdc);
  local_2c = *piVar2;
  __n = (int)local_39 - (int)local_44;
  local_44[0] = *(int *)(DAT_00063130 + 0x62fe4);
  local_44[1] = *(undefined4 *)(DAT_00063130 + 0x62fe8);
  puVar3 = *(undefined1 **)(param_1 + 0x14);
  __dest = *(void **)(param_1 + 0x18);
  __n_00 = (int)puVar3 - (int)__dest;
  uStack_3c = (undefined2)*(undefined4 *)(DAT_00063130 + 0x62fec);
  local_3a = (undefined1)((uint)*(undefined4 *)(DAT_00063130 + 0x62fec) >> 0x10);
  local_39[0] = '\0';
  local_34 = local_39;
  local_30 = local_44;
  if (__n_00 < __n) {
