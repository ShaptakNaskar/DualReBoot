/* 00063138 | STG::UPreference_FileChooser_Texture::GetKeyPrefix */
...

{
  ...
  piVar6 = *(int **)(DAT_000632a0 + 0x63158);
  local_44 = 0x14;
  iVar7 = *(int *)(DAT_000632a4 + 0x63160);
  local_24 = *piVar6;
  local_40 = iVar7 + 8;
  local_2c = local_3c;
  local_28 = local_3c;
  ...
  local_28 = local_2c;
  pvVar2 = memcpy(local_2c,(void *)(DAT_000632a8 + 0x63194),0x13);
  piVar1 = local_28;
