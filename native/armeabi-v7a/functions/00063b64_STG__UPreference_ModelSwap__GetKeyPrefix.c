/* 00063b64 | STG::UPreference_ModelSwap::GetKeyPrefix */
...

{
  ...
  piVar2 = *(int **)(DAT_00063cb8 + 0x63b84);
  local_2c = *piVar2;
  puVar3 = *(undefined1 **)(param_1 + 0x14);
  __dest = *(void **)(param_1 + 0x18);
  __n = (int)local_3b - (int)local_44;
  __n_00 = (int)puVar3 - (int)__dest;
  local_44[0] = *(int *)(DAT_00063cbc + 0x63b8c);
  local_44[1] = *(undefined4 *)(DAT_00063cbc + 0x63b90);
  local_3c = (undefined1)*(undefined4 *)(DAT_00063cbc + 0x63b94);
  local_3b[0] = '\0';
  local_34 = local_3b;
  local_30 = local_44;
  if (__n_00 < __n) {
