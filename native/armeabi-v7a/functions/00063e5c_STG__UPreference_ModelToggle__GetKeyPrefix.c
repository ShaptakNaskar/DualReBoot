/* 00063e5c | STG::UPreference_ModelToggle::GetKeyPrefix */
...

{
  ...
  piVar2 = *(int **)(DAT_00063fcc + 0x63e7c);
  local_2c = *piVar2;
  __n = (int)local_39 - (int)local_44;
  local_44[0] = *(int *)(DAT_00063fd0 + 0x63e84);
  local_44[1] = *(undefined4 *)(DAT_00063fd0 + 0x63e88);
  puVar3 = *(undefined1 **)(param_1 + 0x14);
  __dest = *(void **)(param_1 + 0x18);
  __n_00 = (int)puVar3 - (int)__dest;
  uStack_3c = (undefined2)*(undefined4 *)(DAT_00063fd0 + 0x63e8c);
  local_3a = (undefined1)((uint)*(undefined4 *)(DAT_00063fd0 + 0x63e8c) >> 0x10);
  local_39[0] = '\0';
  local_34 = local_39;
  local_30 = local_44;
  if (__n_00 < __n) {
