/* 0006ab58 | STG::UPreference_TextureFont::GetKeyPrefix */

/* STG::UPreference_TextureFont::GetKeyPrefix(STG::UStringBase<char, int>&) const */

void __thiscall
STG::UPreference_TextureFont::GetKeyPrefix(UPreference_TextureFont *this,UStringBase *param_1)

{
  ...
  piVar2 = *(int **)(DAT_0006acc8 + 0x6ab78);
  local_2c = *piVar2;
  __n = (int)local_39 - (int)local_44;
  local_44[0] = *(int *)(DAT_0006accc + 0x6ab80);
  local_44[1] = *(undefined4 *)(DAT_0006accc + 0x6ab84);
  puVar3 = *(undefined1 **)(param_1 + 0x14);
  __dest = *(void **)(param_1 + 0x18);
  __n_00 = (int)puVar3 - (int)__dest;
  uStack_3c = (undefined2)*(undefined4 *)(DAT_0006accc + 0x6ab88);
  local_3a = (undefined1)((uint)*(undefined4 *)(DAT_0006accc + 0x6ab88) >> 0x10);
  local_39[0] = '\0';
  local_34 = local_39;
  local_30 = local_44;
  if (__n_00 < __n) {
