/* 0006b1dc | STG::UPreference_TextureSwap::GetKeyPrefix */
...

{
  ...
  piVar2 = *(int **)(DAT_0006b34c + 0x6b1fc);
  local_2c = *piVar2;
  __n = (int)local_39 - (int)local_44;
  local_44[0] = *(int *)(DAT_0006b350 + 0x6b204);
  local_44[1] = *(undefined4 *)(DAT_0006b350 + 0x6b208);
  puVar3 = *(undefined1 **)(param_1 + 0x14);
  __dest = *(void **)(param_1 + 0x18);
  __n_00 = (int)puVar3 - (int)__dest;
  uStack_3c = (undefined2)*(undefined4 *)(DAT_0006b350 + 0x6b20c);
  local_3a = (undefined1)((uint)*(undefined4 *)(DAT_0006b350 + 0x6b20c) >> 0x10);
  local_39[0] = '\0';
  local_34 = local_39;
  local_30 = local_44;
  if (__n_00 < __n) {
