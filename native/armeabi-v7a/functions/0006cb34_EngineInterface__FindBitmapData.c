/* 0006cb34 | EngineInterface::FindBitmapData */
...

{
  ...
  iVar15 = DAT_0006ce70 + 0x6cb50;
  uVar3 = *(uint *)(this + 0x18);
  piVar5 = *(int **)(iVar15 + DAT_0006ce74);
  local_2c = *piVar5;
  if (uVar3 == 0) {
      ...
      if (this_00 != (EngineBitmapData *)0x0) {
        ...
        if (iVar2 != 0) {
          ...
          if (uVar3 == 0) {
            ...
            std::__stl_throw_length_error((char *)(DAT_0006ce80 + 0x6ce2c));
          }
          if (0x10 < uVar3) {
            local_68 = uVar3;
            if (uVar3 < 0x81) {
          ...
          *(byte *)local_50 = 0;
          ...
          if (uVar3 == 0) {
                    /* WARNING: Subroutine does not return */
            std::__stl_throw_length_error((char *)(DAT_0006ce84 + 0x6ce38));
          }
          if (0x10 < uVar3) {
            local_68 = uVar3;
            if (uVar3 < 0x81) {
          ...
          *(byte *)local_34 = 0;
          ...
          if (local_4c != local_50) {
            piVar4 = *(int **)(iVar15 + DAT_0006ce7c);
            ppbVar7 = local_4c;
            do {
          ...
          iVar6 = memcmp(local_4c,local_30,sVar10);
          if (iVar6 == 0) {
            if ((int)sVar14 < (int)sVar16) {
              iVar6 = -1;
            }
