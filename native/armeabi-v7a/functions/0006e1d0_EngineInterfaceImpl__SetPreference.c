/* 0006e1d0 | EngineInterfaceImpl::SetPreference */
...

{
  ...
  piVar5 = *(int **)(DAT_0006e3c0 + 0x6e1f0);
  pEVar1 = this;
  if (param_3 == 0) {
    pEVar1 = (EngineInterfaceImpl *)0x0;
  }
  local_2c = *piVar5;
  if (param_3 == 0) goto LAB_0006e30c;
  local_7c = *(undefined4 *)(this + 8);
  iVar6 = *(int *)(DAT_0006e3c4 + 0x6e220);
  ...
  if (param_2 == 5) {
    iVar7 = *(int *)(DAT_0006e3c8 + 0x6e33c) + 8;
    local_b0 = param_5;
    local_ac = 0;
    ...
    StringHelperBase<STG::UStringBase<unsigned_short,unsigned_short>,unsigned_short>::AcquireString
              ((StringHelperBase<STG::UStringBase<unsigned_short,unsigned_short>,unsigned_short> *)
               &local_b4,0xff);
    pEVar1 = (EngineInterfaceImpl *)
             STG::UPreference_Scene::SetValueByKey(pUVar4,5,&local_70,&local_a8);
    ...
    if ((local_80 != local_a4) && (local_80 != (uint *)0x0)) {
      ...
      puVar2 = local_80;
      if (0x80 < uVar3) goto LAB_0006e2cc;
LAB_0006e3a8:
    ...
    pEVar1 = (EngineInterfaceImpl *)
             STG::UPreference_Scene::SetValueByKey(pUVar4,param_2,&local_70,&local_48);
    ...
    if ((local_30 != local_44) && (local_30 != (uint *)0x0)) {
      ...
      puVar2 = local_30;
      if (uVar3 < 0x81) goto LAB_0006e3a8;
LAB_0006e2cc:
