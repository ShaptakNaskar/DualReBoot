/* 00070b30 | std::__stl_throw_runtime_error */
...

{
  ...
  *(int *)this = *(int *)(DAT_00070b84 + 0x70b58) + 8;
  FUN_00070a90(asStack_28);
  FUN_0006f570(this,*(undefined4 *)(DAT_00070b88 + 0x70b6a),*(undefined4 *)(DAT_00070b8c + 0x70b6e))
  ;
  do {
    FUN_0006f528(this);
    __cxa_end_cleanup();
