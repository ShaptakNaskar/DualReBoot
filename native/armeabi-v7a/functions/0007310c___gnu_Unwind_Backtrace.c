/* 0007310c | __gnu_Unwind_Backtrace */
...

{
  ...
  *(undefined4 *)(param_3 + 0x40) = *(undefined4 *)(param_3 + 0x3c);
  ...
  do {
    iVar1 = FUN_00072418(auStack_2a8,local_210);
    if (iVar1 != 0) {
LAB_000731b4:
      iVar1 = 9;
      break;
    }
    FUN_00072874(&local_250,0xc,auStack_2a8);
    iVar1 = (*param_1)(&local_250,param_2);
    if (iVar1 != 0) goto LAB_000731b4;
    iVar1 = (*local_298)(8,auStack_2a8,&local_250);
  } while (iVar1 != 9 && iVar1 != 5);
  FUN_000725ec(&local_250);
  return iVar1;
}
