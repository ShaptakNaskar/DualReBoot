...

{
  ...
  if (param_4 == 0) {
    ...
    if (iVar3 != 0) {
      param_3 = param_3 << iVar3;
      uVar5 = param_1 >> (0x20U - iVar3 & 0xff);
      param_1 = param_1 << iVar3;
      param_2 = uVar5 | param_2 << iVar3;
    }
    uVar5 = param_3 >> 0x10;
...
LAB_00074108:
    ...
    if (param_4 <= param_2) {
      ...
      if (iVar3 != 0) {
        uVar5 = 0x20 - iVar3;
        uVar4 = param_2 >> (uVar5 & 0xff);
        uVar8 = param_3 >> (uVar5 & 0xff) | param_4 << iVar3;
        uVar6 = param_1 >> (uVar5 & 0xff) | param_2 << iVar3;
        uVar5 = uVar8 >> 0x10;
        __aeabi_uidivmod(uVar4,uVar5);
        ...
        if ((uVar4 < uVar6 || uVar4 == uVar6) &&
           (uVar7 = 0, uVar9 + uVar8 <= param_1 << iVar3 || uVar4 != uVar6)) goto LAB_00074118;
        uVar5 = uVar5 - 1;
        goto LAB_00074108;
      }
