/* 00030b74 | STG::UStringBase<char,int>::Find_FromEnd */

/* WARNING: Removing unreachable block (ram,0x00030e34) */
...

{
  ...
  piVar15 = *(int **)(DAT_00031108 + 0x30b8c);
  local_2c = *piVar15;
  sVar4 = strlen(__s);
      ...
      if (__src != pcVar18) {
        ...
        if (__s != pcVar6) {
          ...
          if (__s != pcVar6 + -1) {
            ...
            do {
              for (; local_80[-1] == pcVar6[-1]; local_80 = local_80 + -1) {
                if (__src == local_7c) goto LAB_00030cb8;
                pcVar11 = pcVar6 + -1;
                pcVar14 = local_7c;
                while (pcVar11 = pcVar11 + -1, pcVar14[-1] == *pcVar11) {
                  if (pcVar14 == __s + (1 - (int)pcVar6) + (int)local_80) goto LAB_000310a4;
                  pcVar14 = pcVar14 + -1;
                  if (__src == pcVar14) goto LAB_00030cb8;
                }
                local_7c = local_7c + -1;
              }
              local_80 = local_80 + -1;
          ...
          if (pcVar18[-1] != pcVar6[-1]) {
            ...
            do {
              local_80 = local_80 + -1;
              if (__src == local_80) goto LAB_00030cb8;
              pcVar11 = pcVar11 + -1;
...
LAB_00030cb8:
      if (pcVar18 == pcVar9) goto LAB_00030bbc;
    ...
    if (uVar10 != 0xffffffff) {
      ...
      if (uVar12 == 0) {
        ...
        std::__stl_throw_length_error((char *)(DAT_0003110c + 0x30f48));
      }
      if (0x10 < uVar12) {
        local_60 = uVar12;
        if (uVar12 < 0x81) {
      ...
      *local_4c = (string)0x0;
      ...
      if ((uint)(*(int *)(this + 0x14) - iVar13) < uVar10) {
                    /* WARNING: Subroutine does not return */
        std::__stl_throw_out_of_range((char *)(DAT_00031114 + 0x310fc));
      }
      ...
      if (uVar12 == 0) {
                    /* WARNING: Subroutine does not return */
        std::__stl_throw_length_error((char *)(DAT_00031110 + 0x30f54));
      }
      if (0x10 < uVar12) {
        local_60 = uVar12;
        if (uVar12 < 0x81) {
