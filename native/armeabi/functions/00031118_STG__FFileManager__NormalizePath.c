/* 00031118 | STG::FFileManager::NormalizePath */
...

{
  ...
  piVar7 = *(int **)(DAT_00031424 + 0x31130);
  local_2c = *piVar7;
...
LAB_000311cc:
  if (pbVar3 != __dest) {
    piVar9 = *(int **)(DAT_00031428 + 0x311e0);
    do {
      pbVar5 = __dest + 1;
  ...
  iVar6 = *(int *)(DAT_0003142c + 0x31220);
  local_9c = iVar6 + 8;
  local_6c = (int)&local_7c + 1;
  local_98 = CONCAT22(local_98._2_2_,0x5c);
  local_7c = CONCAT22(local_7c._2_2_,0x2f);
