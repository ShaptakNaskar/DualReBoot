/* 00031980 | STG::FFileManager::GetPathComponents */
...

{
  ...
  piVar12 = *(int **)(DAT_00032300 + 0x31998);
  iVar8 = *(int *)(DAT_00032304 + 0x3199c);
  iVar9 = iVar8 + 8;
  local_2c = *piVar12;
  local_130 = local_140;
  ...
  local_f0 = iVar9;
  local_d8 = &local_ec;
  iVar3 = FUN_00031430((UStringBase *)&local_144,&local_f0,(UStringBase<char,int> *)&local_128,
  ...
  if (iVar3 == 0) {
    ...
    uVar10 = (int)puVar1 - (int)puVar2;
    sVar6 = (int)local_f8 - (int)local_f4;
    if (sVar6 < uVar10) {
      iVar3 = 0;
      if (sVar6 != 0) {
        memmove(local_f4,puVar2,sVar6);
      ...
      if (uVar10 != 0) {
        memmove(local_f4,puVar2,uVar10);
      }
      if ((uint *)((int)local_f4 + uVar10) != local_f8) {
        *(char *)((int)local_f4 + uVar10) = (char)*local_f8;
        local_f8 = (uint *)((int)local_f4 + uVar10);
      }
    }
  }
  local_c0 = local_d0;
  ...
  local_98 = CONCAT22(local_98._2_2_,0x2f);
  local_d4 = iVar9;
  local_bc = local_c0;
  local_b8 = iVar9;
  local_a0 = local_a4;
  ...
  if (iVar3 == 0) {
    ...
    if (sVar6 < uVar10) {
      ...
      if (uVar10 != 0) {
        memmove(local_a0,puVar2,uVar10);
      }
      if ((uint *)((int)local_a0 + uVar10) != local_a4) {
        *(char *)((int)local_a0 + uVar10) = (char)*local_a4;
        local_a4 = (uint *)((int)local_a0 + uVar10);
      }
    }
  }
  local_6c = local_7c;
  ...
  if (iVar3 == 0) {
    ...
    if (sVar6 < uVar10) {
      ...
      if (uVar10 != 0) {
        memmove(local_68,puVar2,uVar10);
      }
      if ((uint *)((int)local_68 + uVar10) != local_6c) {
        *(char *)((int)local_68 + uVar10) = (char)*local_6c;
        local_6c = (uint *)((int)local_68 + uVar10);
      }
    }
  ...
  if ((string *)(param_2 + 4) != (string *)(iVar3 + 4)) {
    pvVar11 = *(void **)(iVar3 + 0x18);
    pcVar7 = *(char **)(iVar3 + 0x14);
    puVar5 = *(undefined1 **)(param_2 + 0x14);
    pvVar4 = *(void **)(param_2 + 0x18);
    uVar10 = (int)pcVar7 - (int)pvVar11;
    sVar6 = (int)puVar5 - (int)pvVar4;
    if (sVar6 < uVar10) {
      iVar3 = 0;
      if (sVar6 != 0) {
        memmove(pvVar4,pvVar11,sVar6);
        iVar3 = *(int *)(param_2 + 0x14) - *(int *)(param_2 + 0x18);
      }
      std::string::_M_append((string *)(param_2 + 4),(char *)((int)pvVar11 + iVar3),pcVar7);
    }
    else {
      if (uVar10 != 0) {
        memmove(pvVar4,pvVar11,uVar10);
        pvVar4 = *(void **)(param_2 + 0x18);
        puVar5 = *(undefined1 **)(param_2 + 0x14);
      }
      if (puVar5 != (undefined1 *)((int)pvVar4 + uVar10)) {
        *(undefined1 *)((int)pvVar4 + uVar10) = *puVar5;
        *(undefined1 **)(param_2 + 0x14) =
             (undefined1 *)((int)pvVar4 + uVar10) + (*(int *)(param_2 + 0x14) - (int)puVar5);
      }
    }
  }
  ...
  if ((string *)(param_3 + 4) != (string *)(iVar3 + 4)) {
    pvVar11 = *(void **)(iVar3 + 0x18);
    pcVar7 = *(char **)(iVar3 + 0x14);
    puVar5 = *(undefined1 **)(param_3 + 0x14);
    ...
    if (sVar6 < uVar10) {
      ...
      std::string::_M_append((string *)(param_3 + 4),(char *)((int)pvVar11 + iVar3),pcVar7);
    }
    else {
      if (uVar10 != 0) {
        memmove(pvVar4,pvVar11,uVar10);
      ...
      if (puVar5 != (undefined1 *)((int)pvVar4 + uVar10)) {
        ...
        *(undefined1 **)(param_3 + 0x14) =
             (undefined1 *)((int)pvVar4 + uVar10) + (*(int *)(param_3 + 0x14) - (int)puVar5);
      }
    }
  }
  ...
  if ((string *)(param_4 + 4) != (string *)(iVar3 + 4)) {
    pvVar11 = *(void **)(iVar3 + 0x18);
    pcVar7 = *(char **)(iVar3 + 0x14);
    puVar5 = *(undefined1 **)(param_4 + 0x14);
    ...
    if (sVar6 < uVar10) {
      ...
      std::string::_M_append((string *)(param_4 + 4),(char *)((int)pvVar11 + iVar3),pcVar7);
    }
    else {
      if (uVar10 != 0) {
        memmove(pvVar4,pvVar11,uVar10);
      ...
      if (puVar5 != (undefined1 *)((int)pvVar4 + uVar10)) {
        ...
        *(undefined1 **)(param_4 + 0x14) =
             (undefined1 *)((int)pvVar4 + uVar10) + (*(int *)(param_4 + 0x14) - (int)puVar5);
      }
    }
  }
  ...
  if ((string *)(param_5 + 4) != (string *)(iVar3 + 4)) {
    pvVar11 = *(void **)(iVar3 + 0x18);
    pcVar7 = *(char **)(iVar3 + 0x14);
    puVar5 = *(undefined1 **)(param_5 + 0x14);
    ...
    if (sVar6 < uVar10) {
      ...
      std::string::_M_append((string *)(param_5 + 4),(char *)((int)pvVar11 + iVar3),pcVar7);
    }
    else {
      if (uVar10 != 0) {
        memmove(pvVar4,pvVar11,uVar10);
      ...
      if (puVar5 != (undefined1 *)((int)pvVar4 + uVar10)) {
        ...
        *(undefined1 **)(param_5 + 0x14) =
             (undefined1 *)((int)pvVar4 + uVar10) + (*(int *)(param_5 + 0x14) - (int)puVar5);
      }
    }
  }
  local_64 = iVar8 + 8;
