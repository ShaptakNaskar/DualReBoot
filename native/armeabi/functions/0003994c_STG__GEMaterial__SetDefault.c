/* 0003994c | STG::GEMaterial::SetDefault */

/* WARNING: Removing unreachable block (ram,0x00039a2c) */
/* WARNING: Removing unreachable block (ram,0x00039a34) */
/* WARNING: Removing unreachable block (ram,0x00039b84) */
/* WARNING: Removing unreachable block (ram,0x00039a44) */
/* WARNING: Removing unreachable block (ram,0x00039b10) */
/* WARNING: Removing unreachable block (ram,0x00039b18) */
/* WARNING: Removing unreachable block (ram,0x00039b7c) */
/* WARNING: Removing unreachable block (ram,0x00039b28) */
...

{
  ...
  piVar6 = *(int **)(DAT_00039bd8 + 0x39964);
  local_24 = *piVar6;
  ...
  *(undefined4 *)(this + 0x154) = 0x3f800000;
  ...
  iVar3 = *(int *)(DAT_00039bdc + 0x399c0);
...
LAB_00039bac:
    *(undefined4 *)(this + 0x88) = 0xffffffff;
    ...
    if (puVar4 == puVar2) goto LAB_00039bac;
    *puVar4 = *puVar2;
