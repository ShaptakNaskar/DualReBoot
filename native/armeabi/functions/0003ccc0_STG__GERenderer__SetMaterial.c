/* 0003ccc0 | STG::GERenderer::SetMaterial */
...

{
  ...
  if (iVar1 == 0) {
    ...
    local_28 = __mulsf3(*(undefined4 *)param_2,*(undefined4 *)(param_1 + 0x148));
    local_24 = __mulsf3(*(undefined4 *)(param_2 + 4),*(undefined4 *)(param_1 + 0x14c));
    local_20 = __mulsf3(*(undefined4 *)(param_2 + 8),*(undefined4 *)(param_1 + 0x150));
    local_1c = __mulsf3(*(undefined4 *)(param_2 + 0xc),*(undefined4 *)(param_1 + 0x154));
