/* 0003dc8c | STG::GERendererAPI::GL_SetTexture */
...

{
  ...
  if ((((param_5 != 0) && (*(ulong *)(param_5 + 0x94) - 1 < 0xfffffffe)) &&
    ...
    iVar2 = iVar1 + 0x3def0 + param_2 * 0x10;
    glTexParameteri(0xde1,0x2801,*(undefined4 *)(iVar2 + 4));
    glTexParameteri(0xde1,0x2800,*(undefined4 *)(iVar1 + 0x3def0 + param_2 * 0x10));
    glTexParameteri(0xde1,0x2802,*(undefined4 *)(iVar2 + 8));
    glTexParameteri(0xde1,0x2803,*(undefined4 *)(iVar2 + 8));
    if (*(char *)(iVar2 + 0xc) == '\0') {
      glDisable(0xde1);
    }
    else {
    ...
    if (*(char *)((int)&DAT_0003dfe4 + param_4 * 8 + DAT_0003df70 + 4) != '\0') {
      glTexParameterf(0xde1,0x84fe,*(undefined4 *)((int)&DAT_0003dfe4 + param_4 * 8 + DAT_0003df70))
      ;
    }
    iVar1 = DAT_0003df74;
    glTexEnvi(0x2300,0x2200,0x8570);
    iVar2 = iVar1 + 0x3e040 + param_3 * 0x30;
    glTexEnvi(0x2300,0x8580,*(undefined4 *)(iVar1 + 0x3e040 + param_3 * 0x30));
