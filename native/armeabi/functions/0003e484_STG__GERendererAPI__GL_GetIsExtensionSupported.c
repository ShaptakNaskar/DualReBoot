/* 0003e484 | STG::GERendererAPI::GL_GetIsExtensionSupported */
...

{
  ...
  piVar13 = *(int **)(DAT_0003e994 + 0x3e49c);
  local_2c = *piVar13;
  iVar12 = *(int *)(DAT_0003e998 + 0x3e4a8);
  ...
  std::string::_M_append
            ((string *)&local_b4,(char *)(DAT_0003e99c + 0x3e508),(char *)(DAT_0003e99c + 0x3e509));
  local_80 = iVar12 + 8;
  local_6c = local_7c;
  local_68 = local_7c;
  ...
  if (uVar6 == 0) {
    ...
    std::__stl_throw_length_error((char *)(DAT_0003e9a8 + 0x3e838));
  }
  ppcVar8 = local_7c;
  if (0x10 < uVar6) {
    local_bc = uVar6;
  ...
  *(undefined1 *)ppcVar8 = 0;
  ...
  if (uVar6 == 0) {
                    /* WARNING: Subroutine does not return */
    std::__stl_throw_length_error((char *)(DAT_0003e9a4 + 0x3e82c));
  }
  if (0x10 < uVar6) {
    local_bc = uVar6;
    if (uVar6 < 0x81) {
  ...
  *local_88 = (string)0x0;
  std::string::_M_append
            ((string *)local_98,(char *)(DAT_0003e9a0 + 0x3e62c),(char *)(DAT_0003e9a0 + 0x3e62d));
  local_64 = iVar12 + 8;
  ...
  if (uVar6 == 0) {
                    /* WARNING: Subroutine does not return */
    std::__stl_throw_length_error((char *)(DAT_0003e9ac + 0x3e870));
  }
      ...
      if (psVar10 == psVar4 + 1) {
        ...
        while (psVar16 = psVar17, psVar9 = local_a4, psVar16 != local_a4) {
          ...
          if (*psVar16 == *psVar4) {
            while( true ) {
              psVar9 = local_a4;
              if (local_a4 == psVar3) goto LAB_0003e75c;
              psVar11 = psVar2 + 1;
              if (*psVar3 != *psVar2) break;
              psVar9 = psVar16;
              psVar2 = psVar11;
              psVar3 = psVar3 + 1;
              if (psVar10 == psVar11) goto LAB_0003e75c;
            }
          }
        }
      }
