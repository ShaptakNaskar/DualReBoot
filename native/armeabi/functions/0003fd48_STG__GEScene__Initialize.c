/* 0003fd48 | STG::GEScene::Initialize */
...

{
  ...
  *(undefined4 *)(this + 0xdc) = 0;
  ...
  if (param_1 == 0) goto LAB_0003fd74;
  ...
  if (uVar7 != *(uint *)(this + 200)) {
    ...
    *(uint *)(this + 200) = uVar7;
    if (uVar7 == 0) {
      ...
      pvVar1 = operator_new__(uVar7 << 2);
      uVar7 = *(uint *)(this + 0xa4);
      *(void **)(this + 0xc4) = pvVar1;
    }
  }
  if (*(uint *)(this + 0xd0) != uVar7) {
    if (*(uint *)(this + 0xd0) != 0) {
    ...
    *(uint *)(this + 0xd0) = uVar7;
    if (uVar7 == 0) {
      uVar7 = *(uint *)(this + 0xa4);
    }
    else {
      pvVar1 = operator_new__(uVar7);
      uVar7 = *(uint *)(this + 0xa4);
      *(void **)(this + 0xcc) = pvVar1;
    }
  }
  if (uVar7 != *(uint *)(this + 0xd8)) {
    if (*(uint *)(this + 0xd8) != 0) {
  ...
  *(uint *)(this + 0xfc) = uVar7;
  if (uVar7 != 0) {
    ...
    uVar7 = 0;
    do {
      *(uint *)(iVar9 + iVar6) = uVar7;
      *(undefined4 *)(iVar8 + iVar6) = 0xffffffff;
      *(undefined4 *)(iVar11 + iVar6) = 0xffffffff;
...
LAB_0003ff34:
  if (uVar5 != 0) {
    ...
    do {
      ...
      *(GEModel **)(*(int *)(this + 0xb0) + uVar7 * 4) = this_01;
      MMatrix::MakeIdentity((MMatrix *)(*(int *)(this + 0xbc) + uVar7 * 0x40));
      MMatrix::MakeIdentity((MMatrix *)(*(int *)(this + 0xc0) + uVar7 * 0x40));
      iVar6 = *(int *)(this + 0xcc);
      iVar8 = *(int *)(this + 0xd4);
      *(uint *)(*(int *)(this + 0xc4) + uVar7 * 4) = uVar7;
      uVar5 = *(uint *)(this + 0xa4);
      *(undefined1 *)(iVar6 + uVar7) = 0;
      *(undefined1 *)(iVar8 + uVar7) = 1;
      uVar7 = uVar7 + 1;
    } while (uVar7 < uVar5);
  }
LAB_0003fd74:
