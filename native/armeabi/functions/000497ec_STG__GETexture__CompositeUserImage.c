/* 000497ec | STG::GETexture::CompositeUserImage */
  ...
  if ((*(int *)(param_1 + 0x14) != *(int *)(param_1 + 0x18)) &&
    ...
    if (iVar8 != 0) {
      ...
      if (((local_34 != (uchar *)0x0) && (iVar8 != 0)) && ((local_30 != 0 && (local_2c[0] != 0)))) {
        uVar2 = GERendererAPI::GL_GetTextureBitPerPixel();
        iVar8 = local_30 * (uVar2 >> 3);
        uVar3 = GERendererAPI::GL_GetTextureBitPerPixel(*param_2);
        uVar3 = uVar3 >> 3;
        ...
        *param_6 = __s;
          ...
          do {
            if ((-1 < local_6c && local_6c < (int)param_4) &&
              ...
              do {
                ...
                puVar11 = puVar11 + (uVar2 >> 3);
                puVar12 = puVar12 + uVar3;
              } while (iVar7 != iVar10);
              puVar12 = (uchar *)*param_6;
            }
            local_6c = local_6c + -1;
            local_68 = local_68 - param_3 * uVar3;
        ...
        GenerateMipChain((EFormat *)param_2,param_3,param_4,__n,puVar12,0);
      }
