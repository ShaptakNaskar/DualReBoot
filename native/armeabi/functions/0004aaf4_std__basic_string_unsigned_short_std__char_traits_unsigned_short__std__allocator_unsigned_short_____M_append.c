/* 0004aaf4 | std::basic_string<unsigned_short,std::char_traits<unsigned_short>,std::allocator<unsigned_short>>::_M_append */
  ...
  if (uVar4 < uVar7) {
    ...
    if (0 < (int)uVar7) {
      ...
      if (uVar8 != 0 &&
        ...
        bVar14 = uVar7 == uVar8 * 2;
        uVar7 = uVar7 + uVar8 * -2;
        puVar2 = puVar2 + uVar8 * 2;
        puVar10 = puVar10 + uVar8 * 2;
        if (bVar14) goto LAB_0004ac00;
      }
      do {
        uVar7 = uVar7 - 1;
        *puVar2 = *puVar10;
...
LAB_0004ac00:
  ...
  if (0x7ffffffe - uVar7 < uVar4) {
    ...
    __stl_throw_length_error((char *)((int)&DAT_0004aebc + DAT_0004aebc));
  }
  uVar8 = uVar7;
  if (uVar7 < uVar4) {
    uVar8 = uVar4;
  ...
  if ((uVar8 < 0x7fffffff) && (uVar7 <= uVar8)) {
    if (uVar8 != 0) {
      local_2c[0] = uVar8 * 2;
      if (0x80 < local_2c[0]) goto LAB_0004ae24;
...
LAB_0004ad10:
      ...
      uVar5 = uVar7 + uVar8 * -2;
      if (uVar7 != uVar8 * 2) goto LAB_0004ad10;
    }
    pbVar12 = pbVar3 + uVar7 * 2;
  }
  if ((int)uVar4 < 1) goto LAB_0004add8;
...
LAB_0004adbc:
    ...
    uVar8 = uVar4 + uVar7 * -2;
    if (uVar4 != uVar7 * 2) goto LAB_0004adbc;
  }
