/* 0004caf8 | STG::GETextureModifier::ModifyTexture */

/* WARNING: Removing unreachable block (ram,0x0004ce38) */
...

{
  ...
  if (this_00 != (string *)(param_1 + 4)) {
    ...
    sVar5 = (int)puVar10 - (int)pvVar1;
    if (sVar5 < uVar15) {
      iVar21 = 0;
      if (sVar5 != 0) {
        memmove(pvVar1,pvVar20,sVar5);
      ...
      if (*(int *)(iVar16 + 0x44) == *(int *)(param_1 + 0x1c)) {
        if (*(char *)(*(int *)(this + 0x1c) + iVar21) != '\0') {
          if (*(char *)(iVar16 + 0x1c) == '\0') {
            cVar4 = *(char *)(iVar16 + 0x24);
            if (cVar4 != '\0') goto LAB_0004cd08;
            iVar11 = 0;
            if (*(int *)(this + 0x28) != 0) {
              iVar11 = *(int *)(*(int *)(this + 0x28) + 0x14);
              iVar6 = *(int *)(iVar16 + 4) * 0x8c;
              iVar11 = (**(code **)(*(int *)(iVar11 + iVar6) + 0x20))(iVar11 + iVar6);
            }
            if (*(int *)(iVar16 + 8) != iVar11) {
              uVar15 = *(uint *)(this + 0x24);
              goto LAB_0004cb90;
            }
          }
...
LAB_0004cd08:
            ...
            if (((cVar4 != '\0') && (*(int *)(iVar16 + 0x20) != *(int *)(this + 0x34))) ||
               (iVar11 == 0)) goto LAB_0004cb90;
          }
...
LAB_0004cc68:
        if (*(char *)(iVar16 + 1) == '\0') goto LAB_0004cc74;
        iVar21 = *(int *)(DAT_0004d1c0 + 0x4cdc4);
        local_80 = iVar21 + 8;
        local_7c = local_7c & 0xffff0000;
        uVar2 = *(ulong *)(iVar16 + 0xc);
        local_5c = &local_7c;
        local_58 = &local_7c;
        if ((*(int *)(this + 0x28) == 0) ||
           (pUVar12 = *(UStringBase **)
                       (uVar2 * 0x90 + *(int *)(*(int *)(this + 0x28) + 0x24) + 0x7c),
           pUVar12 == (UStringBase *)&local_80)) goto LAB_0004d04c;
        puVar22 = *(undefined4 **)(pUVar12 + 0x28);
        puVar13 = *(undefined4 **)(pUVar12 + 0x24);
        uVar15 = (int)puVar13 - (int)puVar22 >> 1;
        if ((uVar15 == 0) || (puVar22 == puVar13)) goto LAB_0004d04c;
        if (uVar15 < 0x10) {
          iVar11 = (int)puVar13 - (int)((int)puVar22 + 2) >> 1;
          if (0 < iVar11) {
            puVar13 = &local_7c;
            puVar17 = puVar22;
            do {
            ...
            } while (puVar17 != (undefined4 *)((int)puVar22 + iVar11 * 2));
          }
          ...
          *(undefined2 *)local_5c = *(undefined2 *)puVar22;
          ...
          if (0x7ffffffe < uVar15) {
            ...
            std::__stl_throw_length_error((char *)(DAT_0004d1c4 + 0x4d1b4));
          }
...
LAB_0004ce50:
          ...
          puVar3 = puVar13 + uVar14;
          uVar8 = uVar19 + uVar14 * -2;
          if (uVar19 != uVar14 * 2) {
LAB_0004cf2c:
            do {
              uVar8 = uVar8 - 1;
              *(undefined2 *)puVar3 = *(undefined2 *)puVar17;
              puVar17 = (undefined4 *)((int)puVar17 + 2);
...
LAB_0004cfe8:
              ...
              puVar3 = puVar17 + uVar19;
              uVar14 = uVar15 + uVar19 * -2;
              puVar22 = puVar22 + uVar19;
              if (uVar19 * 2 != uVar15) goto LAB_0004cfe8;
            }
...
LAB_0004d04c:
        ...
        local_30 = local_50;
        local_2c = local_50;
        iVar11 = GETextureFontContainer::FindByIndex
                           ((GETextureFontContainer *)(this + 0xc),uVar2,(UStringBase *)&local_80,
