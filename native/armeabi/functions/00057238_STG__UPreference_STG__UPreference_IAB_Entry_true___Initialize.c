/* 00057238 | STG::UPreference<STG::UPreference_IAB_Entry,true>::Initialize */

/* STG::UPreference<STG::UPreference_IAB_Entry, true>::Initialize(STG::UStringBase<char, int>
   const&, STG::UStringBase<char, int> const&, STG::UStringBase<char, int> const&, unsigned long) */

void __thiscall
STG::UPreference<STG::UPreference_IAB_Entry,true>::Initialize
