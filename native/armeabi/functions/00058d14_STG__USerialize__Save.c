...

{
  ...
  if (*(int *)(param_2 + 0x1c) != 0) {
    ...
    uVar1 = 0;
    do {
      Save<char,int>(param_1,(UStringBase *)(*(int *)(param_2 + 0x24) + iVar2));
      iVar2 = iVar2 + 0x1c;
      Save(param_1,(FFileHash *)(*(int *)(param_2 + 0x28) + uVar1 * 0x20));
      Save(param_1,(GETimeOfDay *)(*(int *)(param_2 + 0x2c) + uVar1 * 8));
      local_1c = *(undefined4 *)(*(int *)(param_2 + 0x30) + uVar1 * 4);
      uVar1 = uVar1 + 1;
      FFileBase::Write(param_1,(uchar *)&local_1c,4);
