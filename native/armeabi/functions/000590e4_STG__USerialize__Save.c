...

{
  ...
  if (*(int *)(param_2 + 0x34) != 0) {
    uVar1 = 0;
    do {
      Save(param_1,*(GEVertexBuffer **)(*(int *)(param_2 + 0x7c) + uVar1 * 4));
      uVar1 = uVar1 + 1;
  ...
  if (*(int *)(param_2 + 0x30) != 0) {
    uVar1 = 0;
    do {
      Save(param_1,*(GEIndexBuffer **)(*(int *)(param_2 + 0x80) + uVar1 * 4));
      Save(param_1,*(GEMaterial **)(*(int *)(param_2 + 0x84) + uVar1 * 4));
      uVar1 = uVar1 + 1;
    } while (uVar1 < *(uint *)(param_2 + 0x30));
  }
