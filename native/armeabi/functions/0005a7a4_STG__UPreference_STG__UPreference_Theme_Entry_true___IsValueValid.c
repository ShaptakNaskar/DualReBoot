/* 0005a7a4 | STG::UPreference<STG::UPreference_Theme_Entry,true>::IsValueValid */

/* STG::UPreference<STG::UPreference_Theme_Entry, true>::IsValueValid(STG::UStringBase<char, int>
   const&) const */

void __thiscall
STG::UPreference<STG::UPreference_Theme_Entry,true>::IsValueValid
...

{
  ...
  piVar6 = *(int **)(DAT_0005a888 + 0x5a7bc);
  local_24 = *piVar6;
...
LAB_0005a838:
  local_40 = *(int *)(DAT_0005a88c + 0x5a848) + 8;
