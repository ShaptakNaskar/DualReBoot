/* 0005aa80 | STG::UPreference<STG::UPreference_IAB_Entry,true>::SetSelectedValueByName */

/* STG::UPreference<STG::UPreference_IAB_Entry, true>::SetSelectedValueByName(STG::UStringBase<char,
   int> const&) */

void __thiscall
STG::UPreference<STG::UPreference_IAB_Entry,true>::SetSelectedValueByName
...

{
  ...
  piVar6 = *(int **)(DAT_0005ab7c + 0x5aa98);
  local_24 = *piVar6;
...
LAB_0005ab2c:
  local_40 = *(int *)(DAT_0005ab80 + 0x5ab3c) + 8;
