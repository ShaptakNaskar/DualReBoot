/* 0005ac70 | STG::UPreference<STG::GETimeOfDay::EPhase,true>::SetSelectedValueByName */

/* STG::UPreference<STG::GETimeOfDay::EPhase, true>::SetSelectedValueByName(STG::UStringBase<char,
   int> const&) */

void __thiscall
STG::UPreference<STG::GETimeOfDay::EPhase,true>::SetSelectedValueByName
...

{
  ...
  piVar6 = *(int **)(DAT_0005ad6c + 0x5ac88);
  local_24 = *piVar6;
...
LAB_0005ad1c:
  local_40 = *(int *)(DAT_0005ad70 + 0x5ad2c) + 8;
