...

{
  ...
  piVar1 = *(int **)(DAT_0005b8bc + 0x5b748);
  local_1c = *piVar1;
  FFileBase::Peek((uchar *)param_1,(ulong)&local_78);
  if (iStack_74 == DAT_0005b8c4 && local_78 == DAT_0005b8c0) {
  ...
  if (local_80 != 0) {
    ...
    do {
      ...
      Load<char,int>(param_1,(UStringBase *)(*(int *)(param_2 + 0x7c) + iVar2 + 0x1c));
      iVar2 = iVar2 + 0x38;
    } while (uVar3 < local_80);
  }
  iVar2 = *(int *)(DAT_0005b8c8 + 0x5b838) + 8;
  local_38 = iVar2;
