/* 0005bc4c | STG::USerialize::Load */

/* STG::USerialize::Load(STG::FFileBase const*, STG::UPreference_TextureFont&) */

void STG::USerialize::Load(FFileBase *param_1,UPreference_TextureFont *param_2)

{
  ...
  piVar2 = *(int **)(DAT_0005bda4 + 0x5bc64);
  local_24 = *piVar2;
  FFileBase::Peek((uchar *)param_1,(ulong)&local_80);
  if (iStack_7c == DAT_0005bdac && local_80 == DAT_0005bda8) {
  ...
  FFileBase::Read(param_1,&local_89,1);
  iVar1 = DAT_0005bdb0;
  (**(code **)(*(int *)param_2 + 0x48))
            (param_2,local_88,local_89,&local_78,(UStringBase<char,int> *)&local_5c,
             (UStringBase<char,int> *)&local_40);
  iVar1 = *(int *)(iVar1 + 0x5bd1c) + 8;
  local_40 = iVar1;
