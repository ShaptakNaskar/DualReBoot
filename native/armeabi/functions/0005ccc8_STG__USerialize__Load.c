...

{
  ...
  iVar19 = DAT_0005d348 + 0x5cce0;
  piVar11 = *(int **)(iVar19 + DAT_0005d34c);
  local_2c = *piVar11;
...
LAB_0005cd64:
  ...
  if (local_b4 == 0) {
    iVar17 = *(int *)(iVar19 + DAT_0005d350);
  }
  else {
    uVar14 = 0;
    do {
...
LAB_0005d018:
              ...
              *(undefined1 *)local_38 = *(undefined1 *)ppuVar18;
              ...
              if ((uchar *)(-2 - (int)puVar5) < puVar16) {
                ...
                std::__stl_throw_length_error((char *)((int)&DAT_0005d348 + DAT_0005d354));
              }
              puVar6 = puVar16;
              if (puVar16 < puVar5) {
                puVar6 = puVar5;
...
LAB_0005d2ac:
                ...
                local_ac = puVar6;
                if ((uchar *)0x80 < puVar6) goto LAB_0005d2ac;
...
LAB_0005d1b0:
                  ...
                  if (puVar5 != (uchar *)(uVar15 * 4)) goto LAB_0005d1b0;
                }
...
LAB_0005d25c:
                  ...
                  if ((uchar *)(uVar15 * 4) != puVar16) goto LAB_0005d25c;
                }
