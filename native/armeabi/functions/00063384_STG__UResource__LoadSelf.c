/* 00063384 | STG::UResource::LoadSelf */

/* STG::UResource::LoadSelf(STG::FFileHash const&) */

int __thiscall STG::UResource::LoadSelf(UResource *this,FFileHash *param_1)

{
  ...
  local_2c[0] = (**(code **)*piVar5)(piVar5,param_1,0);
  iVar1 = (**(code **)(*(int *)this + 0x10))(this,local_2c[0]);
  if ((local_2c[0] != 0) && (iVar1 != 0)) {
