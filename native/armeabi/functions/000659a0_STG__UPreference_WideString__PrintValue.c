/* 000659a0 | STG::UPreference_WideString::PrintValue */
...

{
  ...
  iVar9 = DAT_00065b88;
  piVar8 = *(int **)(DAT_00065b7c + 0x659c0);
  local_24 = *piVar8;
  __s = (char *)(DAT_00065b80 + 0x659ec);
  snprintf(__s,0x400,(char *)(DAT_00065b84 + 0x659ec),
           *(undefined4 *)(param_1 * 0x2c + *(int *)(this + 0x7c) + 0x28));
  iVar9 = *(int *)(iVar9 + 0x659f8);
  local_40 = iVar9 + 8;
  local_2c = local_3c;
  local_28 = local_3c;
  sVar2 = strlen(__s);
  ...
  if (uVar3 == 0) {
    ...
    std::__stl_throw_length_error((char *)(DAT_00065b90 + 0x65b0c));
  }
  ppcVar5 = local_3c;
  if (0x10 < uVar3) {
    local_44 = uVar3;
  ...
  if (__s + sVar2 != (char *)(DAT_00065b8c + 0x65a7c)) {
    pvVar4 = memcpy(ppcVar5,(char *)(DAT_00065b8c + 0x65a7c),__n);
