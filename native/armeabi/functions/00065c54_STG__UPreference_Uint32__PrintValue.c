/* 00065c54 | STG::UPreference_Uint32::PrintValue */
...

{
  ...
  iVar9 = DAT_00065e3c;
  piVar8 = *(int **)(DAT_00065e30 + 0x65c6c);
  local_24 = *piVar8;
  __s = (char *)(DAT_00065e34 + 0x6608c);
  snprintf(__s,0x20,(char *)(DAT_00065e38 + 0x65c9c),
           *(undefined4 *)(*(int *)(this + 0x7c) + param_1 * 4));
  iVar9 = *(int *)(iVar9 + 0x65ca8);
  local_40 = iVar9 + 8;
  local_2c = local_3c;
  local_28 = local_3c;
  sVar2 = strlen(__s);
  ...
  if (uVar3 == 0) {
    ...
    std::__stl_throw_length_error((char *)(DAT_00065e44 + 0x65dc0));
  }
  ppcVar5 = local_3c;
  if (0x10 < uVar3) {
    local_44 = uVar3;
  ...
  if (__s + sVar2 != (char *)(DAT_00065e40 + 0x6612c)) {
    pvVar4 = memcpy(ppcVar5,(char *)(DAT_00065e40 + 0x6612c),__n);
