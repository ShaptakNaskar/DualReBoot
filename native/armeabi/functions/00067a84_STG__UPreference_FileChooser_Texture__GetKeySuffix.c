/* 00067a84 | STG::UPreference_FileChooser_Texture::GetKeySuffix */
...

{
  ...
  if ((*(int *)(this + 0x8c) != 0) && (*(int *)(this + 0x90) != 0)) {
    __s = (char *)(DAT_00067b0c + 0x67ae0);
    snprintf(__s,0x40,(char *)(DAT_00067b10 + 0x67ae4),*(int *)(this + 0x8c),*(int *)(this + 0x90));
    sVar1 = strlen(__s);
