/* 0006e504 | STG::UPreference_Scene::GetIsValidMultiPref */
...

{
  ...
  piVar10 = *(int **)(DAT_0006e848 + 0x6e51c);
  local_2c = *piVar10;
  ...
  if (pUVar3 != (UPreferenceBase *)0x0 && pUVar4 != (UPreferenceBase *)0x0) {
    ...
    if (((iVar5 == 0) && ((int)sVar13 <= (int)sVar11)) &&
       (bVar15 = false, (int)sVar11 <= (int)sVar13)) goto LAB_0006e5d4;
...
LAB_0006e5c8:
      ...
      if (iVar6 == iVar5) {
        iVar5 = *(int *)(DAT_0006e84c + 0x6e61c);
        iVar12 = 0;
        iVar14 = iVar5 + 8;
        do {
          ...
          if (((iVar7 != 0) || ((int)sVar13 < (int)sVar11)) ||
            ...
            local_64 = iVar5 + 8;
            if (puVar9 == local_60) goto LAB_0006e5d0;
            if (puVar9 == (uint *)0x0) goto LAB_0006e5c8;
