/* 0006e850 | STG::UPreference_Scene::SetValueByKey */
...

{
  ...
  piVar6 = *(int **)(DAT_0006ee34 + 0x6e868);
  local_2c = *piVar6;
  switch(param_2) {
  case 0:
    piVar11 = *(int **)(this + 4);
  ...
  case 7:
    ...
    if (uVar12 < uVar15) {
      ...
      do {
        ...
        if (((iVar2 == 0) && ((int)sVar10 <= (int)sVar16)) && ((int)sVar16 <= (int)sVar10)) {
          if (uVar12 == 0) goto LAB_0006edd4;
          pvVar17 = *(void **)(param_4 + 0x18);
          pvVar13 = *(void **)(param_4 + 0x14);
          iVar2 = *(int *)(DAT_0006ee38 + 0x6eb88);
          ...
          if (uVar15 == 0) {
            ...
            std::__stl_throw_length_error((char *)(DAT_0006ee3c + 0x6edac));
          }
          if (0x10 < uVar15) {
            local_4c = uVar15;
            if (uVar15 < 0x81) {
