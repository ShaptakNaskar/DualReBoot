/* 0006f5a8 | STG::UPreference_TextureFont::GetKeyPrefix */
...

{
  ...
  piVar2 = *(int **)(DAT_0006f6fc + 0x6f5c0);
  local_2c = *piVar2;
  puVar3 = *(undefined1 **)(param_1 + 0x14);
  __dest = *(void **)(param_1 + 0x18);
  local_44[0] = *(int *)(DAT_0006f704 + 0x6f5ec);
  local_44[1] = *(undefined4 *)(DAT_0006f704 + 0x6f5f0);
  __n = (int)local_39 - (int)local_44;
  __n_00 = (int)puVar3 - (int)__dest;
  local_3a = (undefined1)((uint)*(undefined4 *)(DAT_0006f704 + 0x6f5f4) >> 0x10);
  local_3c = (undefined2)*(undefined4 *)(DAT_0006f704 + 0x6f5f4);
  local_39[0] = '\0';
  local_34 = local_39;
  local_30 = local_44;
  if (__n_00 < __n) {
