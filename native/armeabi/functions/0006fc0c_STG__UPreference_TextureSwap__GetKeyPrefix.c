/* 0006fc0c | STG::UPreference_TextureSwap::GetKeyPrefix */
...

{
  ...
  piVar2 = *(int **)(DAT_0006fd60 + 0x6fc24);
  local_2c = *piVar2;
  puVar3 = *(undefined1 **)(param_1 + 0x14);
  __dest = *(void **)(param_1 + 0x18);
  local_44[0] = *(int *)(DAT_0006fd68 + 0x6fc50);
  local_44[1] = *(undefined4 *)(DAT_0006fd68 + 0x6fc54);
  __n = (int)local_39 - (int)local_44;
  __n_00 = (int)puVar3 - (int)__dest;
  local_3a = (undefined1)((uint)*(undefined4 *)(DAT_0006fd68 + 0x6fc58) >> 0x10);
  local_3c = (undefined2)*(undefined4 *)(DAT_0006fd68 + 0x6fc58);
  local_39[0] = '\0';
  local_34 = local_39;
  local_30 = local_44;
  if (__n_00 < __n) {
