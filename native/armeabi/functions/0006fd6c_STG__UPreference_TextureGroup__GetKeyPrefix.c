/* 0006fd6c | STG::UPreference_TextureGroup::GetKeyPrefix */
...

{
  ...
  local_3c[0] = DAT_0006feb0;
  piVar2 = *(int **)(DAT_0006feb4 + 0x6fdac);
  local_3c[1] = DAT_0006feb8;
  local_24 = *piVar2;
  __n_00 = (int)local_30 - (int)local_3c;
  __n = (int)puVar1 - (int)__dest;
  local_3c[2] = DAT_0006febc;
  local_30[0] = '\0';
  local_2c = local_30;
  local_28 = local_3c;
  if (__n < __n_00) {
    ...
    std::string::_M_append((string *)(param_1 + 4),(char *)((int)local_3c + iVar3),local_30);
  }
  else {
    if (__n_00 != 0) {
