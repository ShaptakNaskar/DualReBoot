/* 00070e10 | STG::UPreference_TimeOfDay::PrintValue */
...

{
  ...
  if (uVar3 == 0) {
    ...
    std::__stl_throw_length_error((char *)(DAT_00070fcc + 0x70f50));
  }
  ppcVar5 = local_3c;
  if (0x10 < uVar3) {
    local_44 = uVar3;
