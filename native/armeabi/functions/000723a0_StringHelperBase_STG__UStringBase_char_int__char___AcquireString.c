/* 000723a0 | StringHelperBase<STG::UStringBase<char,int>,char>::AcquireString */
  ...
  if ((piVar2 != (int *)0x0) && (*(int *)(param_1 + 4) != 0)) {
    ...
    *(char **)(param_1 + 8) = __s;
    ...
    if (uVar4 == 0) {
      ...
      std::__stl_throw_length_error((char *)(DAT_00072588 + 0x72520));
    }
