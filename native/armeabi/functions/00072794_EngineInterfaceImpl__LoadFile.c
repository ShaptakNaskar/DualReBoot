/* 00072794 | EngineInterfaceImpl::LoadFile */
...

{
  ...
  piVar3 = *(int **)(DAT_0007290c + 0x727ac);
  local_1c = *piVar3;
  ...
  if (param_1 == 0) {
    ...
    if (iVar1 == 0) {
      ...
      iVar1 = *(int *)(DAT_00072910 + 0x72824);
      local_38 = iVar1 + 8;
      local_3c = 0;
      ...
      local_48 = (FFileBase *)STG::FFileManagerScoped::Open(aFStack_4c,(UStringBase *)&local_38);
