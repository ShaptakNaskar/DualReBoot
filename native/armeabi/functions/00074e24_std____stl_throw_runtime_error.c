/* 00074e24 | std::__stl_throw_runtime_error */
...

{
  ...
  *(int *)this = *(int *)(DAT_00074e78 + 0x74e4c) + 8;
  FUN_00074d84(asStack_28);
  FUN_000737e8(this,*(undefined4 *)(DAT_00074e7c + 0x74e5c),*(undefined4 *)(DAT_00074e80 + 0x74e5e))
  ;
  do {
    FUN_0007379c(this);
    __cxa_end_cleanup();
