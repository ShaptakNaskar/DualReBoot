/* 00074e84 | std::__stl_throw_range_error */
...

{
  ...
  *(int *)this = *(int *)(DAT_00074ed8 + 0x74eac) + 8;
  FUN_00074d84(asStack_28);
  FUN_000737e8(this,*(undefined4 *)(DAT_00074edc + 0x74ebc),*(undefined4 *)(DAT_00074ee0 + 0x74ebe))
  ;
  do {
    FUN_0007379c(this);
    __cxa_end_cleanup();
