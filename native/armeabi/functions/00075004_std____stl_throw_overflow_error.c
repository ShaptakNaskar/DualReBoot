/* 00075004 | std::__stl_throw_overflow_error */
...

{
  ...
  *(int *)this = *(int *)(DAT_00075058 + 0x7502c) + 8;
  FUN_00074d84(asStack_28);
  FUN_000737e8(this,*(undefined4 *)(DAT_0007505c + 0x7503c),*(undefined4 *)(DAT_00075060 + 0x7503e))
  ;
  do {
    FUN_0007379c(this);
    __cxa_end_cleanup();
