/* 000360c0 | STG::FFileManagerScoped::Close */
...

{
  ...
  FUN_0002e044();
  pcVar1 = *(char **)(unaff_EBX + 0x65d8b);
  piVar2 = *(int **)(unaff_EBX + 0x65d8f);
  if (*pcVar1 == '\0') {
    iVar3 = FUN_00080eb0(pcVar1);
    if (iVar3 != 0) {
      iVar3 = *(int *)(unaff_EBX + 0x65d6b) + 8;
      piVar2[6] = (int)(piVar2 + 2);
      piVar2[1] = iVar3;
      piVar2[8] = iVar3;
      piVar2[0xd] = (int)(piVar2 + 9);
      piVar2[0xe] = (int)(piVar2 + 9);
      iVar3 = *(int *)(unaff_EBX + 0x65d93);
      ...
      *(undefined1 *)(piVar2 + 9) = 0;
      ...
      piVar2[0x10] = 0;
      FUN_00080f40(pcVar1);
      __cxa_atexit(*(undefined4 *)(unaff_EBX + 0x65d9b),piVar2,*(undefined4 *)(unaff_EBX + 0x65d97))
      ;
    }
  }
