/* 00039460 | STG::GEEnvironmentSettings::GEEnvironmentSettings */

/* STG::GEEnvironmentSettings::GEEnvironmentSettings() */

void __thiscall STG::GEEnvironmentSettings::GEEnvironmentSettings(GEEnvironmentSettings *this)

{
  ...
  *(undefined4 *)(this + 0x34) = 0x3f800000;
  this[0x38] = (GEEnvironmentSettings)0x0;
  this[0x39] = (GEEnvironmentSettings)0x0;
  return;
}
