/* 0003e2b0 | STG::GERenderer::SetMaterial */
...

{
  ...
  cVar1 = GEMaterial::GetIsEqual(param_1);
  if (cVar1 == '\0') {
    pGVar2 = param_1 + 0x13c;
    ApplyFog((EBlendState *)this);
    GERendererAPI::GL_SetDepthState(*(undefined4 *)(param_1 + 0x144),pGVar2);
    GERendererAPI::GL_SetBlendState(*(undefined4 *)(param_1 + 0x13c));
    GERendererAPI::GL_SetCullState(*(undefined4 *)(param_1 + 0x140));
    local_2c = *(float *)param_2 * *(float *)(param_1 + 0x148);
    local_28 = *(float *)(param_2 + 4) * *(float *)(param_1 + 0x14c);
    local_24 = *(float *)(param_2 + 8) * *(float *)(param_1 + 0x150);
    local_20 = *(float *)(param_2 + 0xc) * *(float *)(param_1 + 0x154);
    GERendererAPI::GL_SetMaterialColor((GEColor *)&local_2c);
