...

{
  ...
  uStack_14 = 0x61079;
  FUN_0002e044();
  local_20 = **(int **)(unaff_EBX + 0x3adbf);
  FFileBase::Peek(param_1,(uchar *)&local_7c,8);
  if (local_78 == 0x544e4654 && local_7c == 0x46455250) {
  ...
  (**(code **)(*(int *)param_2 + 0x48))(param_2,local_84,local_85,local_94,local_58,local_3c);
  UStringBase<char,int>::~UStringBase(local_3c);
  UStringBase<char,int>::~UStringBase(local_58);
  UStringBase<char,int>::~UStringBase(local_94);
  if (local_20 == **(int **)(unaff_EBX + 0x3adbf)) {
    return;
  }
