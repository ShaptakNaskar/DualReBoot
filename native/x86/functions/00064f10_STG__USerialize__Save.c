...

{
  ...
  uStack_14 = 0x64f19;
  FUN_0002e044();
  builtin_memcpy(local_24,"PREFCAMS",8);
...
LAB_0006508f:
        ...
        std::__stl_throw_out_of_range
                  ("_ZN3STG10USerialize4SaveIciEEvPNS_9FFileBaseERKNS_11UStringBaseIT_T0_EE" +
                   unaff_EBX + 0x2a);
      }
      uVar4 = 0;
      while( true ) {
        ...
        iVar3 = *(int *)(iVar5 + 0x18);
        if ((uint)(*(int *)(iVar5 + 0x14) - iVar3) <= uVar4) goto LAB_0006508f;
      }
    }
    local_34 = local_34 + 1;
