...

{
  ...
  local_20[0] = *(undefined4 *)(param_2 + 0x234);
  FFileBase::Write(param_1,(uchar *)local_20,4);
  local_20[0] = *(undefined4 *)(param_2 + 0x240);
  FFileBase::Write(param_1,(uchar *)local_20,4);
  local_20[0] = *(undefined4 *)(param_2 + 0x244);
  FFileBase::Write(param_1,(uchar *)local_20,4);
  if (*(int *)(param_2 + 0x234) != 0) {
    uVar1 = 0;
    do {
      local_20[0] = *(undefined4 *)(*(int *)(param_2 + 0x230) + uVar1 * 4);
      uVar1 = uVar1 + 1;
      FFileBase::Write(param_1,(uchar *)local_20,4);
  ...
  if (*(int *)(param_2 + 0x240) != 0) {
    uVar1 = 0;
    do {
      local_20[0] = *(undefined4 *)(*(int *)(param_2 + 0x238) + uVar1 * 4);
      uVar1 = uVar1 + 1;
      FFileBase::Write(param_1,(uchar *)local_20,4);
