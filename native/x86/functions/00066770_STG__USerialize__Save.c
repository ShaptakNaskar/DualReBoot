...

{
  ...
  local_25 = param_2[0x9c];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  local_25 = param_2[0xa4];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  local_20[0] = *(undefined4 *)(param_2 + 0xa0);
  FFileBase::Write(param_1,(uchar *)local_20,4);
  local_25 = param_2[0xa5];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  local_25 = param_2[0xb0];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  Save(param_1,(MVector2 *)(param_2 + 0xa8));
  local_25 = param_2[0xc0];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  Save(param_1,(MVector3 *)(param_2 + 0xb4));
  local_25 = param_2[0xc1];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  Save(param_1,(GEColor *)(param_2 + 0x88));
  local_20[0] = *(undefined4 *)(param_2 + 0x98);
  FFileBase::Write(param_1,(uchar *)local_20,4);
  local_25 = param_2[0x9d];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  Save<char,int>(param_1,(UStringBase *)(param_2 + 0x38));
  local_25 = param_2[0xc4];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  local_25 = param_2[0xc5];
  FFileBase::Write(param_1,(uchar *)&local_25,1);
  return;
}
