/* 0006e040 | STG::UPreference<STG::UStringBase<unsigned_short,unsigned_short>,true>::SetSelectedValueByName */
...

{
  ...
  local_14 = **(int **)(acosf + unaff_EBX + 5);
  local_30 = *(int *)(unaff_EBX + 0x2ddf1) + 8;
  uVar3 = 0;
  local_1c = local_2c;
  local_18 = local_2c;
  if (*(int *)(this + 0x80) != 0) {
...
LAB_0006e132:
  ...
  if (local_14 == **(int **)(acosf + unaff_EBX + 5)) {
    return uVar3;
  }
