/* 0006e1b0 | STG::UPreference<bool,true>::IsValueValid */
...

{
  ...
  local_14 = **(int **)(glViewport + unaff_EBX + 5);
  local_30 = *(int *)(unaff_EBX + 0x2dc81) + 8;
  uVar3 = 0;
  local_1c = local_2c;
  local_18 = local_2c;
  if (*(int *)(this + 0x80) != 0) {
...
LAB_0006e28e:
  ...
  if (local_14 == **(int **)(glViewport + unaff_EBX + 5)) {
    return uVar3;
  }
