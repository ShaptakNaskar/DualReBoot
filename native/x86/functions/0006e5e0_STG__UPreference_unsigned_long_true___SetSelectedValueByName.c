/* 0006e5e0 | STG::UPreference<unsigned_long,true>::SetSelectedValueByName */
...

{
  ...
  local_14 = **(int **)(fread + unaff_EBX + 5);
  local_30 = *(int *)(unaff_EBX + 0x2d851) + 8;
  uVar3 = 0;
  local_1c = local_2c;
  local_18 = local_2c;
  if (*(int *)(this + 0x80) != 0) {
...
LAB_0006e6d2:
  ...
  if (local_14 == **(int **)(fread + unaff_EBX + 5)) {
    return uVar3;
  }
