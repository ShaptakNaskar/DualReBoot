/* 00071690 | STG::UPreference_Environment::GetKeyPrefix */
...

{
  ...
  if (local_14 == **(int **)((int)&__DT_REL[0x29].r_info + unaff_EBX + 1)) {
    return;
  }
