/* 00071f70 | STG::UPreference_IAB::~UPreference_IAB */

/* STG::UPreference_IAB::~UPreference_IAB() */

void __thiscall STG::UPreference_IAB::~UPreference_IAB(UPreference_IAB *this)

{
  ...
  FUN_0002e044();
  *(int *)this = *(int *)((int)DWORD_ARRAY_00028b54 + unaff_EBX + 0x142b) + 8;
  iVar3 = *(int *)(this + 0x7c);
  if (iVar3 != 0) {
    iVar5 = *(int *)(iVar3 + -4) * 0x38 + iVar3;
    for (iVar4 = iVar5; iVar4 != iVar3; iVar4 = iVar4 + -0x38) {
      iVar3 = iVar4 - iVar5;
      *(int *)(iVar4 + -0x1c) = *(int *)((int)DWORD_ARRAY_00028b54 + unaff_EBX + 0x136f) + 8;
      ...
      *(int *)(iVar5 + -0x38 + iVar3) = *(int *)((int)DWORD_ARRAY_00028b54 + unaff_EBX + 0x136f) + 8
      ;
