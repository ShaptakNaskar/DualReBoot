/* 00072da0 | STG::UPreference_ModelToggle::GetKeyPrefix */
...

{
  ...
  if (local_14 == **(int **)((int)DWORD_ARRAY_00028b54 + unaff_EBX + 0x539)) {
    return;
  }
