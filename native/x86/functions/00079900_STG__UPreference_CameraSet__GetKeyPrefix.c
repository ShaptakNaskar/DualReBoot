/* 00079900 | STG::UPreference_CameraSet::GetKeyPrefix */

/* STG::UPreference_CameraSet::GetKeyPrefix(STG::UStringBase<char, int>&) const */

void __thiscall
STG::UPreference_CameraSet::GetKeyPrefix(UPreference_CameraSet *this,UStringBase *param_1)

{
  ...
  FUN_0002e044();
  local_23[0] = '\0';
  local_2c[0] = 0x656d6143;
  local_14 = **(int **)("_ZN3STG10USerialize4SaveEPNS_9FFileBaseERKNS_21UPreference_ModelSwapE" +
                       unaff_EBX + 0x3c);
  __n = (int)local_23 - (int)local_2c;
  puVar1 = *(undefined1 **)(param_1 + 0x14);
  local_40 = *(void **)(param_1 + 0x18);
  __n_00 = (int)puVar1 - (int)local_40;
  local_2c[1] = 0x65536172;
  local_24 = 0x74;
  local_1c = local_23;
  local_18 = local_2c;
  if (__n_00 < __n) {
  ...
  if (local_14 ==
      **(int **)("_ZN3STG10USerialize4SaveEPNS_9FFileBaseERKNS_21UPreference_ModelSwapE" +
                unaff_EBX + 0x3c)) {
    return;
  }
