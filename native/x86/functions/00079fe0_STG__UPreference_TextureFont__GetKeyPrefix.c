/* 00079fe0 | STG::UPreference_TextureFont::GetKeyPrefix */
...

{
  ...
  if (local_14 ==
      **(int **)("_ZN3STG10USerialize4LoadEPKNS_9FFileBaseERNS_23UPreference_ModelToggleE" +
                unaff_EBX + 0xc)) {
    return;
  }
