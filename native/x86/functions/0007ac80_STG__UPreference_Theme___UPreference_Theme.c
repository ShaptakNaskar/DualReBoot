/* 0007ac80 | STG::UPreference_Theme::~UPreference_Theme */
...

{
  ...
  FUN_0002e044();
  *(int *)this = *(int *)("_ZN3STG10USerialize4SaveEPNS_9FFileBaseERKNS_16GEAnimationCurveE" +
                         unaff_EBX + 0x31) + 8;
  iVar3 = *(int *)(this + 0x7c);
  if (iVar3 != 0) {
    ...
    for (iVar4 = iVar5; iVar4 != iVar3; iVar4 = iVar4 + -0x38) {
      iVar3 = iVar4 - iVar5;
      *(int *)(iVar4 + -0x1c) =
           *(int *)("_ZN3STG10USerialize4LoadEPKNS_9FFileBaseERNS_10GESkeleton11VertexGroupE" +
                   unaff_EBX + 0x42) + 8;
