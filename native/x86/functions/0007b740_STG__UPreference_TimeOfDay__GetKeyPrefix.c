/* 0007b740 | STG::UPreference_TimeOfDay::GetKeyPrefix */
...

{
  ...
  local_14 = **(int **)(
                       "_ZN3STG11UPreferenceINS_23UPreference_Theme_EntryELb1EE21SetSelectedValueIndexEm"
                       + unaff_EBX + 0x37);
  ...
  if (local_14 ==
      **(int **)("_ZN3STG11UPreferenceINS_23UPreference_Theme_EntryELb1EE21SetSelectedValueIndexEm"
                + unaff_EBX + 0x37)) {
    return;
  }
