/* 0007c3b0 | EngineInterface::EngineInterface */
...

{
  ...
  *(undefined4 *)(this + 0x18) = 0;
  this_00 = operator_new(0x37c);
  STG::GERenderer_Android::GERenderer_Android(this_00);
  *(GERenderer_Android **)this = this_00;
  STG::MLocation::MLocation(local_24);
  this_01 = operator_new(0x780);
  STG::GEScene::GEScene(this_01,local_24);
